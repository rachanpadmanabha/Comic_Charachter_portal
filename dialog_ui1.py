...
class Ui_Dialog(object):
    ...
    def loaddata(self):
        ...
        print("Sucessful")
        cur = db.cursor()
        sqlstr = 'SELECT * from protagonist where Publisher_id = 2;'
        ...
        try:
            ...
            sys.exit(1)
        cur1 = db1.cursor()
        sqlstr1 = 'select * from antagonist where Publisher_id = 2;'
        tablerow1 = 0
