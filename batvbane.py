...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        value_set1 = QBarSet("Batman")
        value_set2 = QBarSet("Bane")
    ...
    def get_data(self):
        query1 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Protagonist_id = 1001;"
        query2 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Antagonist_id = 2001;"
        try:
            mydb1 = mc.connect(
                host="localhost",
                user="root",
