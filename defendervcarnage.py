...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        value_set1 = QBarSet("The Defenders")
        value_set2 = QBarSet("Carnage Family")
        ...
        chart.setTitle("The Defenders V/s Carnage Family")
    ...
    def get_data(self):
        query1 = "select stats.intelligence, stats.Strength, stats.Speed, stats.Durability, stats.Power, stats.Combat, stats.Tier from stats inner join Protagonist on stats.Protagonist_id=Protagonist.Protagonist_id where stats.Protagonist_id between 1028 and 1032;"
        query2 = "select stats.intelligence, stats.Strength, stats.Speed, stats.Durability, stats.Power, stats.Combat, stats.Tier from stats inner join Antagonist on stats.Antagonist_id=Antagonist.Antagonist_id where stats.Antagonist_id between 2019 and 2023;"
        try:
            mydb1 = mc.connect(
                host="localhost",
                user="root",
