...
class Ui_Dialog2(object):
    def setupUi(self, Dialog2):
        ...
        Dialog2.resize(1920, 1080)
        self.label = QtWidgets.QLabel(Dialog2)
        self.label.setGeometry(QtCore.QRect(0, 0, 1920, 1080))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("dccc.jpg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")

        self.label1 = QtWidgets.QLabel(Dialog2)
        ...
        self.label2 = QtWidgets.QLabel(Dialog2)
        ...
        self.tableWidget1 = QtWidgets.QTableWidget(Dialog2)
    ...
    def loaddata(self):
        try:
            ...
            sys.exit(1)
        cur = db.cursor()
        sqlstr = 'SELECT * from protagonist where Publisher_id = 1;'
        ...
        try:
            ...
            sys.exit(1)
        cur1 = db1.cursor()
        sqlstr1 = 'select * from antagonist where Publisher_id = 1;'
        tablerow1 = 0
