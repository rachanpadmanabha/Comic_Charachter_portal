...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        value_set1 = QBarSet("Monkey D. Luffy")
        value_set2 = QBarSet("Akainu")
        ...
        chart.setTitle("Luffy V/s Akainu")
    ...
    def get_data(self):
        query1 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Protagonist_id = 1056;"
        query2 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Antagonist_id = 2041;"
        try:
            mydb1 = mc.connect(
                host="localhost",
                user="root",
