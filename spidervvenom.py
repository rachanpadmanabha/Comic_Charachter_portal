...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        value_set1 = QBarSet("Spider-man")
        value_set2 = QBarSet("Venom")
        ...
        chart.setTitle("Spider-man V/s Venom")
    ...
    def get_data(self):
        query1 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Protagonist_id = 1028;"
        query2 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Antagonist_id = 2019;"
        try:
            mydb1 = mc.connect(
                host="localhost",
                user="root",
