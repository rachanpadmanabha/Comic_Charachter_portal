...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        value_set1 = QBarSet("Captain America")
        value_set2 = QBarSet("Thanos")
        ...
        chart.setTitle("Captain America V/s Thanos")
    ...
    def get_data(self):
        query1 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Protagonist_id = 1022;"
        query2 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Antagonist_id = 2013;"
        try:
            mydb1 = mc.connect(
                host="localhost",
                user="root",
