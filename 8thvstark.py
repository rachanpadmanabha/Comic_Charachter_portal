...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        value_set1 = QBarSet("Shunsui Kyoraku")
        value_set2 = QBarSet("Coyote Stark")
        ...
        chart.setTitle("Shunsui Kyoraku V/s Coyote Stark")
    ...
    def get_data(self):
        query1 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Protagonist_id = 1049;"
        query2 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Antagonist_id = 2030;"
        try:
            mydb1 = mc.connect(
                host="localhost",
                user="root",
