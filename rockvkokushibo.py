...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        value_set1 = QBarSet("Rock Pillar")
        value_set2 = QBarSet("Kokushibo")
        ...
        chart.setTitle("Robin V/s Psimon")
    ...
    def get_data(self):
        query1 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Protagonist_id = 1033;"
        query2 = "select intelligence, Strength, Speed, Durability, Power, Combat, Tier from stats where Antagonist_id = 2024;"
        try:
            mydb1 = mc.connect(
                host="localhost",
                user="root",
